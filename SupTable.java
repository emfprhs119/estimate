...
public class SupTable {
	...
	MyJTable table;
	MyJTable tableAdd;
	JTextField sumText,sumTextBottom;	//ªÛ¥‹ «’∞Ë,«œ¥‹ «’∞Ë
	JTextField sumLabelField,sumBlankField;	//«œ¥‹ «’∞Ë ∑π¿Ã∫Ì « µÂøÕ ∫Ûƒ≠ « µÂ
	JLabel sumTextLabel = new JLabel("«’∞Ë±›æ◊ ");
	int index = 0;
	int selx = 0, sely = 0;
	boolean selkey = true;
	...
	public void valueChangedSet(JTable tableA, int rowMax) {
		...
		*/
		...
		if (toNumFormat(sumDatas) == null) {
			...
			sumText.setText(toNumFormat(sumDatas) + "ø¯");
